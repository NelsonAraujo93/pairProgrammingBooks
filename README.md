...
**[Awsome Books]** This project is a JavaScript challenge to work as pair programming giving us the chance to create and remove books from a list of books and storage the data in the localStorage
...
In order to run this project you need: [https://github.com/NelsonAraujo93/pairProgrammingBooks]
...
```sh
  cd my-folder
  git clone https://github.com/NelsonAraujo93/pairProgrammingBooks
```
--->
...
I would like to thank Microverse for giving me the chance to improve my coding. Also Greatings to Majek and Mark to work with me in this project
